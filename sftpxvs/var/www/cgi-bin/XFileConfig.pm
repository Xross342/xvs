...
$c=
{
 license_key => '4fbyllwrtrrpbv4rfqlwqkaerp6cfnctqyzjg2ezg7mt26rldwqq62e4uuj22dagtsa7jeyt2ihfsabf4xwlgxdpfbd4vmnapzdfuv6hxfqtv66r4e',
 ...
 pasword_salt => 'kdgn1utooky1',

 # Secret key to crypt Download requests
 dl_key => 'jixzxm9jxl6cy2mr',
 ...
 site_url => 'https://daimoxaz.xyz',

 # Your site cgi-bin URL, witout trailing /
 site_cgi => 'https://daimoxaz.xyz/cgi-bin',

 cdn_url => 'https://daimoxaz.xyz',
...
#--- Registered users limits ---#
 ...
 # Maximum upload Filesize in Mbytes (0 to disable)
 max_upload_filesize_reg => '0',

 max_upload_files_reg => '0',
 ...
 queue_url_max_reg => '999999999999999999',

 queue_url_working_max_reg => '999999999999999999',
...
#--- Premium users limits ---#
 ...
 queue_url_max_prem => '999999999999999999',

 queue_url_working_max_prem => '999999999999999999',
...
##### Email settings #####
 ...
 srt_auto => '1',
 srt_auto_langs => 'eng=English, rus=Russian, fre=French, fra=French, tur=Turkish, ger=German, deu=German, spa=Spanish, esp=Spanish, gre=Greek, ita=Italian, ara=Arabic, bul=Bulgarian, cat=Catalan, chi=Chinese, zho=Chinese, heb=Hebrew, jpn=Japanese, may=Malay, ind=Indonesian, tha=Thai, ukr=Ukrainian, ben=Bengali',
 ...
 next_upload_server_logic => 'round',
 ...
 player_about_text => 'anime',
 player_about_link => 'Nigger',
 ...
 expire_quality_name => 'l',
 expire_quality_access_reg => '0',
 expire_quality_access_prem => '0',
 ...
 player_playback_rates => '1, 1.25, 1.5, 2, 8',
 ...
 m_w => '1',
 vast_tag => 'https://pubads.g.doubleclick.net/gampad/ads?iu=/21775744923/external/single_ad_samples&sz=640x480&cust_params=sample_ct%3Dlinear&ciu_szs=300x250%2C728x90&gdfp_req=1&output=vast&unviewed_position_start=1&env=vp&correlator=',
 ...
 max_folders_limit_reg => '999',
 max_folders_limit_prem => '999',
